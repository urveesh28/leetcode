...
class Solution
{
    ...
    public static ArrayList<ArrayList<Integer>> printPaths(Node root, int sum)
    {
        ...
        traverse(root,new LinkedList<>(),sum,ans);
        return ans;
    }
    
    private static void traverse(Node root,List<Integer> list,int sum,ArrayList<ArrayList<Integer>> ans){
        if(root==null)return;
        list.add(root.data);
        sum-=root.data;
        ...
        traverse(root.left,list,sum,ans);
        traverse(root.right,list,sum,ans);
